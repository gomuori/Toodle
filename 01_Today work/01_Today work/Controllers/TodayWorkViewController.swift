//
//  TempTodayWorkViewController.swift
//  01_Today work
//
...
class TempTodayWorkViewController: UIViewController {
    ...
    var actions = ["로그인 버튼 시안 제작", "모바일 메인 페이지 제작", "액션을 완료한 상태입니다."]
...
extension TempTodayWorkViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
//extension TempTodayWorkViewController: UITableViewDataSource {
